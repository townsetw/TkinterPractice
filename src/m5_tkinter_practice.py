...
def main():
    ...
    # ------------------------------------------------------------------
    # DONE: 7.
    #    -- Put a second Entry on the Frame. DONE
    #    -- Put a third Button on the frame. DOnE
    ...
    third_button = ttk.Button(frame1, text= 'ONLY integers in box above')
    third_button['command'] = lambda: cool_function(second_entry)
    third_button.grid()
    # ------------------------------------------------------------------
